...
using SwanseaUniversityComputerScienceApp.Models.AccountViewModels;
...
namespace SwanseaUniversityComputerScienceApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = "Posts/Index")
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction(nameof(PostsController.Index), "Posts/Index");
                }
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> LoginWith2fa(bool rememberMe, string returnUrl = "Posts/Index")
        {
